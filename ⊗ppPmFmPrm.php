...
#11
<form action="" method="get">
    <tr>Введите день рождения</tr><br>
    <input name="day"value="<?=$_GET['day']?? 1?>"><br><br>
    <tr>Введите месяц рождения</tr><br>
    <input name="month"value="<?=$_GET['month']?? 1?>"><br><br>
    <tr>Введите дату (ДД.ММ.ГГГГ)</tr><br>
    <input name="date"value="<?=$_GET['month']?? '15.12.2023'?>"><br><br>
    <input type="submit">
</form>
...
$horoscopes = [
    'Овен' => [
        '2023-12-15' => 'Сегодня вам предстоит важное решение, будьте внимательны.',
        '2023-12-16' => 'Сегодня у вас будет много энергии, используйте ее с умом.',
        '2023-12-17' => 'Сегодня вас ждет приятный сюрприз от близкого человека.',
    ],
    'Телец' => [
        '2023-12-15' => 'Сегодня вам предстоит важное решение, будьте внимательны.',
        '2023-12-16' => 'Сегодня у вас будет много энергии, используйте ее с умом.',
...
function getHoroscope($zodiac, $date) {
    global $horoscopes;

    if (isset($horoscopes[$zodiac][$date])) {
        return $horoscopes[$zodiac][$date];
    } else {
        return 'Гороскоп на указанную дату не найден.';
    }
}
...
echo $zodiac."<br>".getHoroscope($zodiac,$date);
?>
